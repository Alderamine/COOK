      ...
      <div className='bg-[white] xsm:w-full md:border-2 md:border-[rgba(255,219,184,1)] md:rounded-[23px] md:h-fit sm:border-2 sm:border-[rgba(255,219,184,1)] sm:rounded-[23px] sm:h-fit w-[50.694vw] md:w-[80.24vw] sm:w-[80.24vw] h-full flex flex-col items-center pt-[105px] md:absolute sm:absolute xsm:absolute md:left-[50%] md:translate-x-[-50%] md:top-[50%] md:translate-y-[-50%] sm:left-[50%] sm:translate-x-[-50%] sm:top-[50%] sm:translate-y-[-50%]'>
        <div className='w-fit h-fit flex flex-col justify-center items-center'>
          ...
          <div className='flex flex-col gap-[8px] mt-[24px]'>
            <button className='hover:bg-primaryLighten2 hover:text-primary transition-all duration-200 flex items-center justify-center gap-[14px] w-[322px] xsm:min-w-[90vw] xsm:w-full h-[56px] border border-[rgba(255,219,184,1)] font-outfit font-normal text-[20px] leading-[30px]'>
              <img src={Google} alt="" />
              Continue with Google
            </button>
            <button className='flex hover:bg-primaryLighten2 hover:text-primary transition-all duration-200 items-center justify-center gap-[14px] w-[322px] xsm:w-full h-[56px] border border-[rgba(255,219,184,1)] font-outfit font-normal text-[20px] leading-[30px]'>
