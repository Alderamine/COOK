    ...
    <div>
      ...
      <div className='flex xsm:flex-col sm:flex-col xsm:gap-[36px] sm:gap-[36px] gap-[54px] pl-[64px] py-[94px] pr-[69px] sm:pt-[89px] sm:px-[48px] xsm:pt-[80px] xsm:pr-[32px] xsm:pl-[34px]'>
        <div className='mt-[10px]'>
          <h1 className='mb-[36px] hidden sm:block xsm:block text-[48px] xsm:text-[36px] font-[700] sm:leading-[56.88px] font-rubik'>Terms of Service</h1>
        ...
        <div className='flex flex-col xsm:w-full sm:w-full'>
          <h1 className='mb-[36px] mt-[-10px] block sm:hidden xsm:hidden text-[48px] xsm:text-[36px] font-[700] sm:leading-[56.88px] font-rubik'>Terms of Service</h1>
          ...
          <div className='ml-[31px] mr-[45.5px]'>
            <div className='flex gap-[154px] pt-[54px] pb-[43px] ml-[49.5px]'>
              ...
              <div className='flex-1 flex justify-between'>
                ...
                <p className='self-end text-[white] text-[20px] leading-[30px] font-outfit'>2023 TermsOfService</p>
              </div>
            </div>
          </div>
        </div>
