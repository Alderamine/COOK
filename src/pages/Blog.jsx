      ...
      <section className='w-full px-[64px] md:px-[48px] sm:px-[48px] xsm:px-[32px] mt-[131px]'>
        ...
        <div className='grid grid-cols-3 md:grid-cols-2 sm:grid-cols-1 xsm:grid-cols-1 gap-x-[21px] gap-y-[36px]'>
          <BlogCategoriesCard img={<svg className='min-w-[32px] min-h-[32px] max-w-[32px] max-h-[32px]' width="100" height="100" viewBox="0 0 100 100" fill="none" xmlns="http://www.w3.org/2000/svg">
            <g clip-path="url(#clip0_1283_44982)">
          ...
          <BlogCategoriesCard img={<svg className='min-w-[32px] min-h-[32px] max-w-[32px] max-h-[32px]' width="100" height="100" viewBox="0 0 100 100" fill="none" xmlns="http://www.w3.org/2000/svg">
            <mask id="mask0_1283_44896" style={{maskType:"luminance"}} maskUnits="userSpaceOnUse" x="0" y="0" width="100" height="100">
              <path d="M2 98V2H98V98H2Z" fill="white" stroke="#D27722" stroke-width="6" />
            </mask>
            <g mask="url(#mask0_1283_44896)">
              <mask id="mask1_1283_44896" style={{maskType:"luminance"}} maskUnits="userSpaceOnUse" x="4" y="5" width="91" height="91">
                <path d="M92.9998 93.0004V7.00005H6.99951V93.0004H92.9998Z" fill="white" stroke="white" stroke-width="6" />
              </mask>
              <g mask="url(#mask1_1283_44896)">
                <path d="M78.1252 91.4847H22.0508V70.3909H78.1252V91.4847Z" stroke="#D27722" stroke-width="6" stroke-miterlimit="10" />
                <path d="M30.0683 40.1565C28.648 34.2028 27.8516 28.3793 27.8516 23.7209C27.8516 15.3234 37.7678 8.51576 50.0001 8.51576C62.2324 8.51576 72.1486 15.3234 72.1486 23.7209C72.1486 28.3188 71.3381 34.1595 69.8949 40.1565" stroke="#D27722" stroke-width="6" stroke-miterlimit="10" />
                <path d="M41.5622 69.9768C41.5622 69.9768 37.7458 62.2535 34.3218 53.3401" stroke="#D27722" stroke-width="6" stroke-miterlimit="10" />
                <path d="M70.5664 19.7658C82.7987 19.7658 91.4844 26.5735 91.4844 34.9709C91.4844 53.3402 78.3008 70.0394 78.3008 70.0394" stroke="#D27722" stroke-width="6" stroke-miterlimit="10" />
                <path d="M29.4332 19.7658C17.2009 19.7658 8.51514 26.5735 8.51514 34.9709C8.51514 53.3402 21.8746 70.0394 21.8746 70.0394" stroke="#D27722" stroke-width="6" stroke-miterlimit="10" />
              </g>
            </g>
          </svg>
