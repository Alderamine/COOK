        ...
        {allChats.map((chat) => (
          <div className='card flex cursor-pointer hover:bg-[#cccccc27] items-center gap-[16px] px-[23px] py-[12px] sm:px-0 xsm:px-0 xsm:pr-[4px]' key={chat.id} onClick={() => handleCardClick(chat.id)}>
            ...
            <div className='flex flex-col gap-[7px]'>
              ...
              <h1 className='ellipsisShow font-outfit text-[16px] leading-[18.13px] tracking-[-0.02em] text-[#949494] font-[400]'>{chat.message}</h1>
            </div>
          </div>
        ))}
      </div>
                ...
                <div className='flex gap-[16px] items-center'>
                  ...
                  <div className='flex items-center flex-1 border-[2px] border-primaryLighten2 rounded-[4px] h-[44px] px-[15px] '>
                    ...
                    <svg width="25" height="25" viewBox="0 0 25 25" fill="none" xmlns="http://www.w3.org/2000/svg">
                      <path d="M22.4384 2.3053L11.4384 13.3053" stroke="#D27722" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" />
                      <path d="M22.4384 2.3053L15.4384 22.3053L11.4384 13.3053L2.43835 9.3053L22.4384 2.3053Z" stroke="#D27722" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" />
                    </svg>
                  </div>
                </div>
              </div>
