...
const GroupPage = () => {
  return (
    <div>
      <div className='flex gap-[71px] sm:flex-col md:flex-col sm:gap-[42px] md:gap-[42px] xsm:flex-col xsm:gap-[59px] ml-[64px] mr-[71px] sm:ml-[50px] sm:mr-[48px] md:mr-[48px] md:ml-[50px] xsm:mr-[34px] xsm:ml-[30px]'>
        <div className='flex flex-col mt-[80px] sm:mt-[55px] md:mt-[55px] xsm:mt-[37px] gap-[16px] xsm:flex-col-reverse xsm:gap-[27px]'>
          ...
          <div>
            <img src={mainImage} className='w-[52.638888888888886vw] xsm:mt-10 sm:w-full md:w-full xsm:w-full' alt="" />
          </div>
        </div>
                ...
                <div className='flex flex-col justify-between w-full items-center'>
                  <div className='flex justify-between w-full items-center'>
                    ...
                    <div className='flex gap-[5px] items-center'>
                      ...
                      <img src={ratingStar} className='w-[22px] h-[22px]' alt="" />
                    </div>
                  </div>
      ...
      <div className='pl-[62px] md:pl-[23px] sm:pl-[23px] xsm:pl-[23px] mt-[92px] sm:mt-[75px] md:mt-[75px] xsm:mt-[57px]'>
        <h1 className='font-rubik p-[10px] text-[24px] leading-[28.44px] font-[600] tracking-[-0.02em] mb-[16px]'>Other groups</h1>
        <div className='pl-[16px] flex pb-[49px] gap-[20px] xsm:pl-10px overflow-hidden'>
          {[1, 2].map((val, index) => {
            return (
        ...
        <div className='px-[32px] xsm:px-[16px] flex justify-center gap-[12px] xsm:justify-end items-center'>
          <img src={left} className='hover:cursor-pointer' alt="" />
          <img src={right} className='hover:cursor-pointer' alt="" />
        </div>
      </div>
    </div>
  )
