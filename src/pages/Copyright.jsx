          ...
          <div className='md:hidden sm:hidden xsm:hidden flex gap-[24px]'>
            <Link to={'/search-tutors'} className='flex gap-[7px]'>
              <svg className='min-w-[24px] min-h-[24px]' width="24" height="25" viewBox="0 0 24 25" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                <path d="M15.5933 14.6145H17.0944" stroke="#FFDBB8" stroke-miterlimit="13.3333" stroke-linecap="round" stroke-linejoin="round" />
                ...
                <g mask="url(#mask0_1287_44710)">
                  <path d="M12.3577 17.516H6.55014C4.78186 17.516 3.35107 16.0817 3.35107 14.3169V13.8564H15.5567V14.3169C15.5567 16.0817 14.1259 17.516 12.3577 17.516Z" fill="#FFDBB8" stroke="#FFDBB8" stroke-miterlimit="13.3333" stroke-linecap="round" stroke-linejoin="round" />
                  <path d="M19.9229 15.3384H17.1738V13.89H19.9229C20.3237 13.89 20.6471 14.2134 20.6471 14.6142C20.6471 15.015 20.3237 15.3384 19.9229 15.3384Z" fill="#FFDBB8" stroke="#FFDBB8" stroke-miterlimit="13.3333" stroke-linecap="round" stroke-linejoin="round" />
                  <path d="M11.0655 10.3354C10.2535 11.1475 10.3519 12.5678 10.3519 12.5678C10.3519 12.5678 11.7721 12.6697 12.5842 11.8541C13.3963 11.0421 13.2978 9.62181 13.2978 9.62181C13.2978 9.62181 11.8776 9.52338 11.0655 10.3354Z" fill="#FFDBB8" stroke="#FFDBB8" stroke-miterlimit="13.3333" stroke-linecap="round" stroke-linejoin="round" />
                  <path d="M5.35007 12.2226C5.87036 12.7429 6.93202 12.5249 6.93202 12.5249C6.93202 12.5249 7.14998 11.4632 6.62969 10.9429C6.10589 10.4227 5.04774 10.6406 5.04774 10.6406C5.04774 10.6406 4.82978 11.7023 5.35007 12.2226Z" fill="#FFDBB8" stroke="#FFDBB8" stroke-miterlimit="13.3333" stroke-linecap="round" stroke-linejoin="round" />
                  <path d="M7.35059 8.85942C7.35059 9.45353 7.8322 9.93866 8.42983 9.93866C9.02394 9.93866 9.50907 9.45704 9.50907 8.85942C9.50907 8.26179 9.02394 7.78017 8.42983 7.78017C7.8322 7.78017 7.35059 8.2653 7.35059 8.85942Z" fill="#FFDBB8" stroke="#FFDBB8" stroke-miterlimit="13.3333" stroke-linecap="round" stroke-linejoin="round" />
                  <path d="M11.0435 7.78135C11.0435 8.12938 11.3247 8.4071 11.6692 8.4071C12.0137 8.4071 12.2985 8.12938 12.2985 7.78135C12.2985 7.43332 12.0172 7.1556 11.6727 7.1556C11.3282 7.1556 11.0435 7.43332 11.0435 7.78135Z" fill="#FFDBB8" stroke="#FFDBB8" stroke-miterlimit="13.3333" stroke-linecap="round" stroke-linejoin="round" />
                  <path d="M8.59912 11.6408V12.1716Z" fill="#FFDBB8" />
                  <path d="M8.59912 11.6408V12.1716" stroke="#FFDBB8" stroke-miterlimit="13.3333" stroke-linecap="round" stroke-linejoin="round" />
                </g>
              </svg>
            ...
            <Link to={'/search-groups'} className='flex gap-[7px]'>
              <svg className='min-w-[24px]' width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                <g clip-path="url(#clip0_1287_44705)">
