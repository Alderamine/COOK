...
export default function GroupCard({background='white'}) {

  const [arr, setArr] = useState([1, 2, 3]);

  return (
    <div style={{background:background}} className='min-w-[313px] rounded-[12px] border border-[rgba(255,219,184,1)]'>
      ...
      <div className='divide-y mx-[16px] divide-[rgba(255,219,184,1)]'>
        <div className='mt-[16px] flex flex-col gap-[16px]'>
          ...
          <p className='font-outfit font-normal text-[16px] leading-[24px]'>Lorem ipsum dolor sit amet consectetur. Massa consequat cras tortor cras morbi amet...</p>
        </div>
