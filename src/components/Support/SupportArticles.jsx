...
export default function SupportArticles() {
  ...
  return (
    <>
      <nav class="ml-[12.153vw] mr-[10.764vw] rounded-md">
      ...
      <main className='ml-[12.153vw] mr-[10.764vw] border border-[rgba(255,219,184,1)] rounded-[16px] p-[32px] divide-y divide-[rgba(255,219,184,1)]'>
