...
export default function BlogArticle() {
  ...
  return (
    <>
      ...
      <div>
        <h1 className='font-rubik font-bold text-[48px] leading-[56.16px] tracking-[-0.02em] text-center mt-[141px]'>Lorem Ipsum</h1>
      ...
      <div className='mt-[82px] w-full px-[64px] flex gap-[61px]'>
        <div className='w-fit'>
        ...
        <div className='w-[639px]'>
          ...
          <div className='flex items-center justify-center gap-[26px] my-[55px]'>
        ...
        <div>
          ...
          <div className='w-full border border-[rgba(255,219,184,1)] mt-[18px] rounded-[8px] p-[24px]'>
      ...
      <section className='mt-[166px] w-full px-[64px] mb-[-55px]'>
